...
abstract class AssetRuntimeUpdateConfig with _$AssetRuntimeUpdateConfig {
  ...
  const factory AssetRuntimeUpdateConfig({
    ...
    @Default('https://api.github.com/repos/kmdclassic/coins')
    String coinsRepoApiUrl,
    @Default('https://raw.githubusercontent.com/kmdclassic/coins')
    ...
    @Default(<String, String>{
      'master': 'https://kmdclassic.github.io/coins',
      'main': 'https://kmdclassic.github.io/coins',
    })
